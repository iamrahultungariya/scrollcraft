...
export function PrimitivesShowcase() {
  ...
  return (
    <section className="relative w-full py-28 px-4 sm:px-6 lg:px-8 bg-[#050505] border-t border-zinc-900">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Live Responsive Deck */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {PRIMITIVES.map((item, idx) => (
            <Reveal key={item.id} effect="fade-up" duration={550} delay={idx * 90}>
              <div className="group relative flex flex-col justify-between rounded-xl border border-zinc-800/80 bg-zinc-950/60 p-6 hover:border-zinc-700/80 transition-all duration-300 backdrop-blur-sm h-full">
                <div>
                  {/* Header */}
                ...
                {/* Code Snippet Box */}
                <div className="relative rounded-lg bg-black/80 border border-zinc-900 p-3.5 font-mono text-xs text-zinc-300 mt-2">
                  <button
