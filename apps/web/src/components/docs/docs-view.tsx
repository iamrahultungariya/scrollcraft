        ...
        extraActions={
          <>
            ...
            <button
              ...
              className="md:hidden p-2 rounded-full border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-900 text-zinc-400 hover:text-white transition-colors cursor-pointer flex items-center gap-1.5 text-xs"
              title={mobileMenuOpen ? 'Close docs outline' : 'Open docs outline'}
            >
              <BookOpen className="w-4 h-4 text-violet-400" />
              <span className="text-[11px] font-medium text-zinc-300">Topics</span>
            </button>
          </>
        }
      />
